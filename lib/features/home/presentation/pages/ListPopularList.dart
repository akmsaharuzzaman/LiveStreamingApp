...
class ListPopularRooms extends StatefulWidget {
  ...
  const ListPopularRooms({
    super.key,
    required this.availableVideoRooms,
...
class _ListPopularRoomsState extends State<ListPopularRooms> {
  ...
  void initState() {
    ...
    _log(
      '📦 Initialized with ${_availableAudioRooms.length} cached audio rooms',
    );
  ...
  Widget build(BuildContext context) {
    final bool isEmpty =
        _availableAudioRooms.isEmpty && widget.availableVideoRooms.isEmpty;
    ...
    final Widget scrollableContent = isEmpty
        ...
        : GridView.builder(
            ...
            itemCount:
                widget.availableVideoRooms.length + _availableAudioRooms.length,
                  ...
                  onTap: () {
                    ...
                    context.pushNamed(
                      ...
                      queryParameters: {
                        ...
                        'hostName':
                            widget
                                .availableVideoRooms[index]
                                .hostDetails
                                ?.name ??
                            'Unknown Host',
                        'hostUserId':
                            widget.availableVideoRooms[index].hostDetails?.id ??
                            'Unknown User',
                        'hostAvatar':
                            widget
                                .availableVideoRooms[index]
                      ...
                      extra: {
                        'existingViewers':
                            widget.availableVideoRooms[index].membersDetails,
                        'hostCoins':
                            widget.availableVideoRooms[index].hostCoins,
                        'roomData': widget.availableVideoRooms[index],
                      },
                    );
                  },
                );
                    ...
                    if (authState is AuthAuthenticated) {
                      ...
                      context.push(
                        ...
                        extra: {
                          ...
                          'numberOfSeats':
                              _availableAudioRooms[audioIndex].numberOfSeats,
