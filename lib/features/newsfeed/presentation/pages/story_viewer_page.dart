  ...
  List<UserStoryGroup> _groupStoriesByUser(List<StoryModel> stories) {
    ...
    return groupedMap.entries.map((entry) {
      ...
      return UserStoryGroup(
        ...
        userAvatar: firstStory.userInfo?.avatar,
        stories: userStories,
      );
    }).toList();
  }
        ...
        Positioned(
          ...
          child: Row(
            children: [
              ...
              CircleAvatar(
                radius: 20,
                backgroundImage: story.userInfo?.avatar != null
                    ? CachedNetworkImageProvider(story.userInfo!.avatar!)
                    : null,
                backgroundColor: Colors.grey[600],
                child: story.userInfo?.avatar == null
                    ? Text(
