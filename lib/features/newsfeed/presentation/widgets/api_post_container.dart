...
class _ApiPostContainerState extends State<ApiPostContainer> {
    ...
    return InkWell(
      onTap: () {
        showModalBottomSheet(
          ...
          builder: (context) =>
              UserProfileBottomSheet(userId: widget.post.ownerId),
        );
      },
      child: Row(
        children: [
  ...
  Widget _buildPostStats(BuildContext context) {
    ...
    final int safeCommentCount = (widget.post.commentCount) > 0
          ...
          children: [
            ListTile(
              ...
              onTap: () {
                ...
                // Handle save post
                debugPrint('Save post: ${widget.post.id}');
              },
            ),
            ListTile(
              ...
              onTap: () {
                Navigator.pop(context);
                // Handle report post
                debugPrint('Report post: ${widget.post.id}');
              },
            ),
            ...
            if (_isOwnPost()) ...[
              ...
              ListTile(
                ...
                onTap: () {
                  Navigator.pop(context);
                  // Handle hide post
                  debugPrint('Hide post: ${widget.post.id}');
                },
              ),
            ],
          ],
  ...
  void _handleShare(BuildContext context) {
    ...
    debugPrint('Share post: ${widget.post.id}');
