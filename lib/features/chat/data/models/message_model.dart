...
final List<Message> recentChats = [
  Message(
    sender: addison,
    avatar: 'assets/images/new_images/Addison.jpg',
    time: '01:25',
    text: "typing...",
    unreadCount: 1,
  ),
  Message(
    sender: jason,
    avatar: 'assets/images/new_images/Jason.jpg',
    time: '12:46',
  ...
  Message(
    sender: deanna,
    avatar: 'assets/images/new_images/Deanna.jpg',
    time: '05:26',
    text: "That's so cute.",
    unreadCount: 3,
  ),
  Message(
      sender: nathan,
      avatar: 'assets/images/new_images/Nathan.jpg',
      time: '12:45',
...
final List<Message> allChats = [
  ...
  Message(
    ...
    unreadCount: 0,
    isRead: true,
    text: "assets/images/profile.png",
  ),
  Message(
    sender: judd,
    avatar: 'assets/images/new_images/person.png',
