import 'package:dlstarlive/features/reels/custom_package/src/components/comment_item.dart';
import 'package:dlstarlive/features/reels/custom_package/src/models/reel_comment_model.dart';
import 'package:flutter/material.dart';

class CommentBottomSheet extends StatefulWidget {
  final List<ReelCommentModel> commentList;
  final Function(String)? onComment;
  const CommentBottomSheet({super.key, required this.commentList,this.onComment});
