import 'package:dlstarlive/features/reels/custom_package/src/components/user_profile_image.dart';
import 'package:dlstarlive/features/reels/custom_package/src/models/reel_model.dart';
import 'package:dlstarlive/features/reels/custom_package/src/utils/convert_numbers_to_short.dart';
              ...
              Column(
                children: [
                  ...
                  IconButton(
                    ...
                    onPressed: () {
                      if (onComment != null) {
                        // Call onComment with empty string to trigger opening comments page
                        onComment!('');
                      }
                    },
                  ),
