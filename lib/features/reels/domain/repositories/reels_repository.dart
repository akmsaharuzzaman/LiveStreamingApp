...
abstract class ReelsRepository {
  ...
  // Comment management
  Future<Map<String, dynamic>?> getReelComments(String reelId, {int page = 1, int limit = 10});
  ...
  Future<bool> replyToComment(String commentId, String reelId, String commentText);
}
