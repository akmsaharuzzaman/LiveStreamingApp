          ...
          builder: (context) {
            ...
            if ((widget.user.level ?? 0) > 0) {
              return Stack(
                ...
                children: [
                  (widget.user.currentLevelBackground != null &&
                          widget.user.currentLevelBackground!.isNotEmpty)
                      ? Image.network(
                          widget.user.currentLevelBackground!,
                          fit: BoxFit.fill,
                          height: 24.h,
                          width: 62.w,
                        )
                  ...
                  Positioned(
                    ...
                    child: Row(
                      children: [
                        (widget.user.currentLevelTag != null &&
                                widget.user.currentLevelTag!.isNotEmpty)
                            ? Image.network(
                                widget.user.currentLevelTag!,
                                fit: BoxFit.fill,
                                height: 24.h,
                                width: 24.w,
                              )
