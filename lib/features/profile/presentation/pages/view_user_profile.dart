              ...
              return Stack(
                ...
                children: [
                  (userProfile?.currentLevelBackground != null && userProfile!.currentLevelBackground!.isNotEmpty)
                      ? Image.network(userProfile!.currentLevelBackground!, fit: BoxFit.fill, height: 30.h, width: 70.w)
                      : Container(
                          height: 30.h,
                          width: 70.w,
                    ...
                    child: Row(
                      ...
                      children: [
                        (userProfile?.currentLevelTag != null && userProfile!.currentLevelTag!.isNotEmpty)
                            ? Image.network(userProfile!.currentLevelTag!, fit: BoxFit.fill, height: 30.h, width: 30.w)
                            : Container(),
                        SizedBox(width: 4.w),
                        Text(
