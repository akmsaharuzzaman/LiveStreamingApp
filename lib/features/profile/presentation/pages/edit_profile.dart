...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  Future<void> _selectDate(BuildContext context) async {
    ...
    if (picked != null) {
      ...
      context
          .read<LogInBloc>()
          .add(LogInEvent.birthDayChanged(birthDay: formatted));
    ...
    return Scaffold(
      body: BlocListener<ProfileBloc, ProfileState>(
        ...
        child:
          ...
          final formatted =
              formatDate(state.userProfile.result?.birthday ?? '');
                  ...
                  children: [
                    ...
                    OutlinedButton(
                      ...
                      style: OutlinedButton.styleFrom(
                        minimumSize:
                            Size(0, 32), // Height: 32, Width will wrap content
                        side: const BorderSide(
                            color: Color(0xff2c3968), width: 1.2),
                      ...
                      child: Row(
                        ...
                        children: [
                          const Icon(Icons.save,
                              size: 16, color: Color(0xff2c3968)),
                                    ...
                                    : state.userProfile.result?.avatar != null
                                        ? CircleAvatar(
                                            ...
                                            backgroundImage: NetworkImage(
                                              state.userProfile.result?.avatar
                                                      ?.url ??
                                                  '',
                                            ),
                                            // Image URL
                      ...
                      decoration: InputDecoration(
                        ...
                        border: OutlineInputBorder(
                          ...
                          borderSide: BorderSide(
                              width: 1.w, color: Colors.grey.shade200),
                        ),
