...
class AppNavigation {
  ...
  static GoRouter get router {
    if (_router == null) {
      throw Exception('AppNavigation not initialized. Call AppNavigation.initialize() first.');
    }
    return _router!;
  }
  ...
  static String get currentLocation => router.routerDelegate.currentConfiguration.fullPath;
}
